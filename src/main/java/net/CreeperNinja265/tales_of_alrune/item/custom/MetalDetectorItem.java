package net.CreeperNinja265.tales_of_alrune.item.custom;
...
public class MetalDetectorItem extends Item {
    ...
    private void outputNoValuableFound(Player player) {
        player.sendSystemMessage(Component.translatable("item.tales_of_alrune.metal_detector.no_valuables"));
    }
